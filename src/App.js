...
import {ADDRESS_PREFIX, API_SERVER, CRYPTIX_UNIT, SOCKET_SERVER, SUFFIX} from "./explorer_constants";
                ...
                <BlueScoreContext.Provider value={{blueScore}}>
                                    ...
                                    <Navbar.Brand>
                                        <Link to="/">
                                            <div className="navbar-brand">
                                                ...
                                                <div className="navbar-brand-text text-start">CRYPTIX<br/>EXPLORER{SUFFIX}
                                                </div>
                                            </div>
                                        </Link>
                                    </Navbar.Brand>
                    ...
                    <OverlayTrigger placement="right" overlay={<Tooltip id="donate">Donation address</Tooltip>}>
                      <Link className="blockinfo-link ms-3"
                            to="/addresses/cryptix:qqkqkzjvr7zwxxmjxjkmxxdwju9kjs6e9u82uh59z07vgaks6gg62v8707g73"><BiDonateHeart
                          size="1.3rem"/></Link>
                    </OverlayTrigger>
