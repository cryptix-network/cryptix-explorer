...
import { CRYPTIX_UNIT } from "../explorer_constants";
import {numberWithCommas} from "../helper";
import {getCoinSupply} from '../cryptix-api-client';
            ...
            <table>
                ...
                <tr>
                    ...
                    <td className="pt-1">$ {(circCoinsMData * price / 1000000000).toFixed(2)} B <a
                        href="https://www.coingecko.com/en/coins/cryptix" target="_blank" className="rank ms-1">Rank
