...
import {getBlockdagInfo, getFeeEstimate, getHashrateMax, getCryptixdInfo} from '../cryptix-api-client';
import {numberWithCommas} from "../helper";
import {BPS, CRYPTIX_UNIT} from "../explorer_constants";
...
const BlockDAGBox = () => {
    ...
    const initBox = async () => {
        ...
        const cryptixdInfo = await getCryptixdInfo()
        ...
        setMempool(cryptixdInfo.mempoolSize)
        localStorage.setItem("mempool", cryptixdInfo.mempoolSize)
    }
            ...
            <table style={{fontSize: "1rem"}}>
                ...
                <tr>
                    ...
                    <td className="pt-1 text-nowrap">
                        CRYPTIX {process.env.REACT_APP_NETWORK.toUpperCase()}
                    </td>
                </tr>
                <tr>
                    <td className="cardBoxElement">
                ...
                <tr>
                    ...
                    <td className="pt-1" id="feerateReg">
                        ≈ {feerate > 300 ? (feerate * 3165 / 100000000).toFixed(2) : (feerate * 3165 / 100000000)} {CRYPTIX_UNIT}
                    </td>
                </tr>
            </table>
        </div>
