...
import {getCoinSupply, getHalving} from '../cryptix-api-client';
import {API_SERVER, CRYPTIX_UNIT} from "../explorer_constants";
        ...
        <div className="cardBox mx-0">
            <table style={{fontSize: "1rem"}}>
                ...
                <tr>
                    ...
                    <td className="">
                        <div id="coins">{numberWithCommas(circCoins)} {CRYPTIX_UNIT}
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td className="pt-1">{(circCoins / 29000000000 * 100).toFixed(2)} %</td>
                </tr>
                <tr>
                    <td className="cardBoxElement align-top">Block reward</td>
                    <td className="pt-1">{process.env.REACT_APP_NETWORK === "mainnet" ? `${blockReward} ${CRYPTIX_UNIT}` : '-'}</td>
                </tr>
                <tr>
                    ...
                    <td className="pt-1">{process.env.REACT_APP_NETWORK === "mainnet" ? <>{halvingDate}<br/>
                        <div className="text-end w-100 pe-3 pt-1" style={{fontSize: "small"}}>to {halvingAmount} {CRYPTIX_UNIT}
                        </div></> : "-"}
                    </td>
                </tr>
            </table>
